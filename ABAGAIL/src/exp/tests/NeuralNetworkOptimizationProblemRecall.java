 ...
 * @version 1.0
 */
public class NeuralNetworkOptimizationProblemRecall implements HillClimbingProblem, GeneticAlgorithmProblem {
     ...
     */
    public NeuralNetworkOptimizationProblemRecall(DataSet examples,
             NeuralNetwork network, MyRecallTestMetric measure) {
        eval = new NeuralNetworkEvaluationFunctionRecall(network, examples, measure);
