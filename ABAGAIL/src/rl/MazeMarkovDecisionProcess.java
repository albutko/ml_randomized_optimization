...
public class MazeMarkovDecisionProcess implements MarkovDecisionProcess {
    ...
    /**
     * @see MarkovDecisionProcess#getStateCount()
     */
    ...
    /**
     * @see MarkovDecisionProcess#getActionCount()
     */
    ...
    /**
     * @see MarkovDecisionProcess#reward(int, int)
     */
    ...
    /**
     * @see MarkovDecisionProcess#transitionProbability(int, int, int)
     */
    ...
    /**
     * @see MarkovDecisionProcess#sampleState(int, int)
     */
    ...
    /**
     * @see MarkovDecisionProcess#sampleInitialState()
     */
    ...
    /**
     * @see MarkovDecisionProcess#isTerminalState(int)
     */
