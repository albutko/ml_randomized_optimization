 ...
 * @date 2013-03-05
 */
public class MyConfusionMatrixTestMetric extends TestMetric {
     ...
     * @param labels
     */
    public MyConfusionMatrixTestMetric(double[] labels) {
     ...
     * @param labels
     */
    public MyConfusionMatrixTestMetric(int[] labels) {
        this.labels    = new Instance[labels.length];
        this.labelStrs = new String[labels.length];
        for (int i = 0; i < labels.length; i++) {
            this.labels   [i] = new Instance(labels[i]);
     ...
     * @param labels
     */
    public MyConfusionMatrixTestMetric(boolean[] labels) {
        this.labels    = new Instance[labels.length];
        this.labelStrs = new String[labels.length];
        for (int i = 0; i < labels.length; i++) {
            this.labels   [i] = new Instance(labels[i]);
     ...
     * @param labelDesc
     */
    public MyConfusionMatrixTestMetric(DataSetDescription labelDesc) {
    ...
    public void addResult(Instance expected, Instance actual) {        
        ...
        // matrix is readable.
        Instance found = findLabel(this.labels, actual.getLabel());
        MatrixEntry e = new MatrixEntry(expected.getLabel(), found);
