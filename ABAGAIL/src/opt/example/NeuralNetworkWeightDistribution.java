...
public class NeuralNetworkWeightDistribution extends AbstractDistribution {
    ...
    /**
     * @see dist.Distribution#probabilityOf(Instance)
     */
    ...
    /**
     * @see dist.Distribution#generateRandom(Instance)
     */
    ...
    /**
     * @see dist.Distribution#generateMostLikely(Instance)
     */
    ...
    /**
     * @see dist.Distribution#estimate(DataSet)
     */
