...
public class ConditionalStateDistributionWrapper implements StateDistribution {
    ...
    /**
     * @see StateDistribution#p(int, Instance)
     */
    ...
    /**
     * @see StateDistribution#generateRandomState(Instance)
     */
    ...
    /**
     * @see StateDistribution#mostLikelyState(Instance)
     */
    ...
    /**
     * @see StateDistribution#estimate(double[][], DataSet)
     */
